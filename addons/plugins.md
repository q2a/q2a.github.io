...
- [Markdown Editor Plugin](https://github.com/fardina/markdown-editor-for-q2a) by [Scott Vivian](http://codelair.co.uk/) of [PokéBase](http://pokemondb.net/pokebase/). [Markdown](http://en.wikipedia.org/wiki/Markdown) is a simple markup format that is readable as plain text.
