...
[QtoA-Mobile](https://appsmata.github.io/QtoA-Mobile/) by [Siro Devs](https://github.com/SiroDevs/) is a new mobile app client for Question2Answer sites made using [Flutter 3.0](https://flutter.io) framework which means you can publish to either Android or iOS which uses qa-api, a simple Q2A custom API. To use QtoA-Mobile, you need to build **qa-mobile** flutter app for your site using Android Studio / Visual Studio Code as per your needs then clone **qa-api** to the root directory of your Q2A site.
