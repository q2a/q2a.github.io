...
- [Memes for Text](https://github.com/thibaultduponchelle/q2a-memes) by [Thibault Duponchelle](https://github.com/thibaultduponchelle). Post *lolfaces* in your answers/comments.
- [WYSIWYG Math Editor](https://github.com/thibaultduponchelle/q2a-wysiwyg-matheditor) by [Thibault Duponchelle](https://github.com/thibaultduponchelle). A CKEditor 4 editor plugin *with math capabilities*. Allow users to add math formulas (mathjax) in your questions/answers/comments. Looking for math editor ? Check also other alternatives based on *preview zone* like [SCEditor](https://github.com/q2apro/q2apro-sceditor) already mentionned above and [q2a-formatter](https://github.com/tangruize/q2a-formatter) (or [google code prettify and mathjax](https://github.com/arjunsuresh/mathjax) from [Arjun Suresh](https://github.com/arjunsuresh) from which [q2a-formatter](https://github.com/tangruize/q2a-formatter) is forked)
